                ...
                <View>
                    ...
                    <View className="mt-5 gap-3">
                        {statusSteps.map((step) => (
                            ...
                            >
                                <View
                                    className={`mt-0.5 h-6 w-6 items-center justify-center rounded-full ${step.done ? "bg-slate-950" : "bg-slate-200"
                                        }`}
                                >
                                    <Text
                                        className={`text-xs font-bold ${step.done ? "text-white" : "text-slate-500"
                                            }`}
                                    >
                                        {step.done ? "✓" : ""}
                                    </Text>
